...
private:
    ...
    float probabilidad_acumulada[MAX_SUJETOS];
    //    string *poblacion_actual = new string [MAX_SUJETOS];
    //    string *nueva_poblacion = new string [MAX_SUJETOS];
    //    double *probabilidad_acumulada = new double [MAX_SUJETOS];
    //int r = rand() % 100;
    ...
    int* Bin2Dec(string Cad, int longitud_gen, int XYZ[]);
    ...
    void normalizarAdaptacion(int* adaptacion, float* adaptacionNormal, int cantidad_sujetos);
